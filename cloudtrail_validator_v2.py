...
1. BUILD: Build reference corpus from real CloudTrail logs
   python cloudtrail_validator_v2.py --build /path/to/real/logs/

2. APPEND: Add more logs to existing corpus
   python cloudtrail_validator_v2.py --append /path/to/more/logs/

3. VALIDATE: Validate test logs against corpus
   python cloudtrail_validator_v2.py test.json [--csv]
"""
